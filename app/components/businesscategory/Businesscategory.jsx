...
const BusinessCategory = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-10">
        <div className='py-[40px]'><h1 className='text-center text-4xl lg:text-6xl font-black text-[#ad8c19]'>AFROHARVEST <span className='text-4xl lg:text-6xl  font-thin text-gray-400'>PRODUCTS</span></h1></div>
